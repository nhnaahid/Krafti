...
const NewsLetter = () => {
    ...
    return (
        <div className="bg-[#ffb901] mt-24 px-3 md:px-24 py-7">
            <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0">
                ...
                <div className="join">
                    <input className={`input-sm md:input input-bordered join-item w-4/5 md:w-full ${theme === 'dark' && 'text-gray-200'}`} placeholder="Email" />
