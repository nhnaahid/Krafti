...
const Footer = () => {
    return (
        <div className='bg-black mt-20 text-white'>
            <div className="w-1/2 text-center mx-auto py-8">
                ...
                <div className="mt-10">
                    <p className="text-sm font-poppins">Copyright © 2024, Krafti. All rights reserved. | Designed by Kraftech | Terms of Use | Privacy Policy | Sitemap</p>
                </div>
            </div>
        </div>
    );
